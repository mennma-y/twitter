        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a href="serch.php" class="nav-link"><img src="../Views/img/icon-search.svg" alt=""></a></li>
                    ...
                    data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-html="true" data-bs-content="<a href='profile.php'>プロフィール</a><br><a href='sign-out.php'>ログアウト</a>"></li>
                </ul>
            </div>
        </div>
        <div class="main">
                            ...
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn-reverse" data-bs-dismiss="modal">キャンセル</button>
